...
// MEC Pro can be found on the asset store here https://assetstore.unity.com/packages/slug/68480
// 
...
namespace MEC
{
    public class Timing : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("When using manual timeframe, should it run automatically after the update loop or only when TriggerManualTimeframeUpdate is called.")]
        ...
        /// </summary>
        [Tooltip("A count of the number of LateFixedUpdate coroutines that are currently running.")]
        ...
        private readonly Dictionary<CoroutineHandle, HashSet<CoroutineHandle>> _pendingResume =
        ...
        void Update()
        {
            ...
            if (_fixedUpdateRan && _nextLateFixedUpdateProcessSlot > 0)
            {
                ...
                for (coindex.i = 0; coindex.i < _lastLateFixedUpdateProcessSlot; coindex.i++)
                {
                    try
                    {
                        if (!LateFixedUpdatePaused[coindex.i] && !LateFixedUpdateHeld[coindex.i] && LateFixedUpdateProcesses[coindex.i] != null && !(localTime < LateFixedUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeparateTags ? ("Processing Coroutine (Late Fixed Update), " +
                                        ...
                                        : "Processing Coroutine (Late Fixed Update)");
                            }
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            if (_handleToIndex.ContainsKey(waiterEnum.Current))
                                            {
                                                ...
                                                if (waiterIndex.seg == Segment.LateFixedUpdate && waiterIndex.i < coindex.i)
                                                {
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!LateFixedUpdatePaused[coindex.i] && !LateFixedUpdateHeld[coindex.i] && LateFixedUpdateProcesses[coindex.i] != null
                            && !(localTime < LateFixedUpdateProcesses[coindex.i].Current))
                        {
                            currentCoroutine = _indexToHandle[coindex];

                            if (ProfilerDebugAmount != DebugInfoType.None)
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeparateTags
                                    ? ("Processing Coroutine (Late Fixed Update)" +
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.LateFixedUpdate)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                            ...
                            else if (LateFixedUpdateProcesses[coindex.i] != null && float.IsNaN(LateFixedUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    LateFixedUpdateProcesses[coindex.i] = ReplacementFunction(
                                        LateFixedUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                    ...
                    catch (System.Exception ex)
                    {
                        ...
                        if (ex is MissingReferenceException)
                            Debug.LogError("This exception can probably be fixed by adding "
                                + "\"CancelWith(gameObject)\" when you run the coroutine.\n"
                                + "Example: Timing.RunCoroutine(_foo().CancelWith(gameObject), Segment.LateFixedUpdate);");
                    }
                }
            }
            ...
            if (_lastSlowUpdateTime + TimeBetweenSlowUpdateCalls < Time.realtimeSinceStartup && _nextSlowUpdateProcessSlot > 0)
            {
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!SlowUpdatePaused[coindex.i] && !SlowUpdateHeld[coindex.i] && SlowUpdateProcesses[coindex.i] != null
                            && !(localTime < SlowUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            else if (SlowUpdateProcesses[coindex.i] != null && float.IsNaN(SlowUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    SlowUpdateProcesses[coindex.i] = ReplacementFunction(
                                        SlowUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
            ...
            if (_nextRealtimeUpdateProcessSlot > 0)
            {
                ...
                for (coindex.i = 0; coindex.i < _lastRealtimeUpdateProcessSlot; coindex.i++)
                {
                    try
                    {
                        if (!RealtimeUpdatePaused[coindex.i] && !RealtimeUpdateHeld[coindex.i] && RealtimeUpdateProcesses[coindex.i] != null && !(localTime < RealtimeUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            if (ProfilerDebugAmount != DebugInfoType.None)
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeparateTags ? ("Processing Coroutine (Realtime Update), " +
                                        (_processLayers.ContainsKey(_indexToHandle[coindex]) ? "layer " + _processLayers[_indexToHandle[coindex]] : "no layer") +
                                        (_processTags.ContainsKey(_indexToHandle[coindex]) ? ", tag " + _processTags[_indexToHandle[coindex]] : ", no tag"))
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.RealtimeUpdate && waiterIndex.i < coindex.i)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!RealtimeUpdatePaused[coindex.i] && !RealtimeUpdateHeld[coindex.i] && RealtimeUpdateProcesses[coindex.i] != null
                            && !(localTime < RealtimeUpdateProcesses[coindex.i].Current))
                        {
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.RealtimeUpdate)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                            ...
                            else if (RealtimeUpdateProcesses[coindex.i] != null && float.IsNaN(RealtimeUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    RealtimeUpdateProcesses[coindex.i] = ReplacementFunction(
                                        RealtimeUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
                    ...
                    try
                    {
                            ...
                            && !(localTime < UpdateProcesses[coindex.i].Current))
                        {
                            ...
                            else if (UpdateProcesses[coindex.i] != null && float.IsNaN(UpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    UpdateProcesses[coindex.i] = ReplacementFunction(
                                        UpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
        ...
        void FixedUpdate()
        {
            ...
            if (_nextFixedUpdateProcessSlot > 0)
            {
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!FixedUpdatePaused[coindex.i] && !FixedUpdateHeld[coindex.i] && FixedUpdateProcesses[coindex.i] != null
                            && !(localTime < FixedUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            else if (FixedUpdateProcesses[coindex.i] != null && float.IsNaN(FixedUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    FixedUpdateProcesses[coindex.i] = ReplacementFunction(
                                        FixedUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
        ...
        void LateUpdate()
        {
            ...
            if (_nextLateUpdateProcessSlot > 0)
            {
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!LateUpdatePaused[coindex.i] && !LateUpdateHeld[coindex.i] && LateUpdateProcesses[coindex.i] != null
                            && !(localTime < LateUpdateProcesses[coindex.i].Current))
                        {
                            ...
                            else if (LateUpdateProcesses[coindex.i] != null && float.IsNaN(LateUpdateProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    LateUpdateProcesses[coindex.i] = ReplacementFunction(
                                        LateUpdateProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
        ...
        /// then this function will be automatically called every Update, so you would normally want to set that variable to false before
                ...
                for (coindex.i = 0; coindex.i < _lastManualTimeframeProcessSlot; coindex.i++)
                {
                    try
                    {
                            ...
                            !(localTime < ManualTimeframeProcesses[coindex.i].Current))
                        {
                            ...
                            if (ProfilerDebugAmount != DebugInfoType.None)
                            {
                                Profiler.BeginSample(ProfilerDebugAmount == DebugInfoType.SeparateTags ? ("Processing Coroutine (Manual Timeframe), " +
                                        (_processLayers.ContainsKey(_indexToHandle[coindex]) ? "layer " + _processLayers[_indexToHandle[coindex]] : "no layer") +
                                        (_processTags.ContainsKey(_indexToHandle[coindex]) ? ", tag " + _processTags[_indexToHandle[coindex]] : ", no tag"))
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.ManualTimeframe && waiterIndex.i < coindex.i)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                    ...
                    try
                    {
                            ...
                            && !(localTime < ManualTimeframeProcesses[coindex.i].Current))
                        {
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.ManualTimeframe)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                            ...
                            else if (ManualTimeframeProcesses[coindex.i] != null && float.IsNaN(ManualTimeframeProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    ManualTimeframeProcesses[coindex.i] = ReplacementFunction(
                                        ManualTimeframeProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
        ...
        private System.Collections.IEnumerator _EOFPump()
        {
            while (_nextEndOfFrameProcessSlot > 0)
            {
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.EndOfFrame && waiterIndex.i < coindex.i)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                ...
                while (_resumeCount > 0)
                {
                    ...
                    try
                    {
                        if (!EndOfFramePaused[coindex.i] && !EndOfFrameHeld[coindex.i] && EndOfFrameProcesses[coindex.i] != null
                            && !(localTime < EndOfFrameProcesses[coindex.i].Current))
                        {
                                ...
                                if (_indexToHandle.ContainsKey(coindex))
                                {
                                    ...
                                    if (_pendingResume.ContainsKey(finishedHandle))
                                    {
                                        ...
                                        while (waiterEnum.MoveNext())
                                        {
                                            ...
                                            {
                                                ProcessIndex waiterIndex = _handleToIndex[waiterEnum.Current];
                                                if (waiterIndex.seg == Segment.EndOfFrame)
                                                {
                                                    if (_resumeCount == _resumeBuffer.Length)
                                                    {
                                                        int[] newBuffer = new int[_resumeBuffer.Length * 2];
                            ...
                            else if (EndOfFrameProcesses[coindex.i] != null && float.IsNaN(EndOfFrameProcesses[coindex.i].Current))
                            {
                                if (ReplacementFunction != null)
                                {
                                    EndOfFrameProcesses[coindex.i] = ReplacementFunction(
                                        EndOfFrameProcesses[coindex.i], _indexToHandle[coindex]);
                                    ReplacementFunction = null;
                                }
                                _resumeBuffer[_resumeCount++] = coindex.i;
                            }
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, GameObject gameObj)
        {
            return coroutine == null ? new CoroutineHandle() : Instance.RunCoroutineInternal(coroutine, Segment.Update,
                ...
                gameObj == null ? 0 : gameObj.GetEntityId().GetHashCode(), gameObj != null, null, new CoroutineHandle(Instance._instanceID), true);
#else
        ...
        public static CoroutineHandle RunCoroutine(IEnumerator<float> coroutine, GameObject gameObj, string tag)
        {
            return coroutine == null ? new CoroutineHandle() : Instance.RunCoroutineInternal(coroutine, Segment.Update,
#if UNITY_6000_4_OR_NEWER
                gameObj == null ? 0 : gameObj.GetEntityId().GetHashCode(), gameObj != null, tag, new CoroutineHandle(Instance._instanceID), true);
#else
...
#if UNITY_6000_4_OR_NEWER
                gameObj == null ? 0 : gameObj.GetEntityId().GetHashCode(), gameObj != null, null, new CoroutineHandle(_instanceID), true);
#else
        ...
        public CoroutineHandle RunCoroutineOnInstance(IEnumerator<float> coroutine, GameObject gameObj, string tag)
        {
            return coroutine == null ? new CoroutineHandle() : RunCoroutineInternal(coroutine, Segment.Update,
#if UNITY_6000_4_OR_NEWER
                gameObj == null ? 0 : gameObj.GetEntityId().GetHashCode(), gameObj != null, tag, new CoroutineHandle(_instanceID), true);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? RunCoroutine(coroutine) : RunCoroutineSingleton(coroutine, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingleton(coroutine, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? RunCoroutine(coroutine, segment) : RunCoroutineSingleton(coroutine, segment, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingleton(coroutine, segment, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingletonOnInstance(coroutine, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingletonOnInstance(coroutine, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingletonOnInstance(coroutine, segment, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : RunCoroutineSingletonOnInstance(coroutine, segment, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
        ...
        {
            int retVal = _nextUpdateProcessSlot + _nextLateUpdateProcessSlot + _nextFixedUpdateProcessSlot + _nextLateFixedUpdateProcessSlot + _nextSlowUpdateProcessSlot +
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return _instance == null ? 0 : _instance.KillCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode());
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return KillCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode());
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return _instance == null ? 0 : _instance.KillCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return KillCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? 0 : PauseCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode());
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return _instance == null ? 0 : _instance.PauseCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? 0 : PauseCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return _instance == null ? 0 : _instance.ResumeCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode());
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? 0 : ResumeCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode());
#else
        ...
        /// no effect.
        /// </summary>
        /// <param name="layer">Any coroutines previously paused on the matching layer will be resumed.</param>
        /// <returns>The number of coroutines that were resumed.</returns>
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return _instance == null ? 0 : _instance.ResumeCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        {
#if UNITY_6000_4_OR_NEWER
            return gameObj == null ? 0 : ResumeCoroutinesOnInstance(gameObj.GetEntityId().GetHashCode(), tag);
#else
        ...
        public static void WaitForOtherHandles(CoroutineHandle handle, CoroutineHandle otherHandle, bool warnOnIssue = true)
        {
                ...
                !inst.CoindexIsNull(inst._handleToIndex[otherHandle]))
            {
                ...
                if (!inst._pendingResume.ContainsKey(otherHandle))
                    inst._pendingResume.Add(otherHandle, new HashSet<CoroutineHandle> { handle });
                else
                    inst._pendingResume[otherHandle].Add(handle);
            }
        }
        ...
        public static void WaitForOtherHandles(CoroutineHandle handle, IEnumerable<CoroutineHandle> otherHandles, bool warnOnIssue = true)
        {
            ...
            while (othersEnum.MoveNext())
            {
                ...
                if (!inst._pendingResume.ContainsKey(othersEnum.Current))
                    inst._pendingResume.Add(othersEnum.Current, new HashSet<CoroutineHandle> { handle });
                else
                    inst._pendingResume[othersEnum.Current].Add(handle);
            }
        }
        ...
        /// <param name="slave">The coroutine that receives the link events</param>
        ...
        public static float GetMyHandle(System.Action<CoroutineHandle> receiver)
        {
            _tmpRef = receiver;
        ...
        {
            System.Action<CoroutineHandle> receiver = _tmpRef as System.Action<CoroutineHandle>;
            if (receiver != null)
                receiver(handle);
            return input;
        }
    ...
    public struct CoroutineHandle : System.IEquatable<CoroutineHandle>
    {
        ...
        /// <summary>
        /// Get or set the corresponding coroutine's segment.
        /// </summary>
...
#if UNITY_6000_4_OR_NEWER
                Timing.RunCoroutineSingleton(coroutine, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : Timing.RunCoroutineSingleton(coroutine, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                Timing.RunCoroutineSingleton(coroutine, segment, gameObj.GetEntityId().GetHashCode(), behaviorOnCollision);
#else
...
#if UNITY_6000_4_OR_NEWER
                : Timing.RunCoroutineSingleton(coroutine, segment, gameObj.GetEntityId().GetHashCode(), tag, behaviorOnCollision);
#else
...
public static class MECExtensionMethods2
{
    ...
    /// <summary>
    /// Cancels this coroutine when any of the supplied game objects are destroyed or made inactive.
    /// </summary>
    /// <param name="coroutine">The coroutine handle to act upon.</param>
    /// <param name="gameObject1">The first GameObject to test.</param>
    /// <param name="gameObject2">The second GameObject to test</param>
